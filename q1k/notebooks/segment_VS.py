...
def imports():
    ...
    from q1k.segment.tasks import segment_vs, TASK_PARAMS
    from q1k.io import get_sync_loss_path, get_segment_path
    return (mne, mne_bids, np, plt, warnings, segment_vs,
...
def header(subject_id, task_id):
    import marimo as mo
    mo.md(f"# Single Subject Segmentation Q1K - VS\n\n"
...
@app.cell
def create_epochs(segment_vs, eeg_raw, eeg_events, eeg_event_dict):
    epochs, event_id, conditions = segment_vs(
