...
def imports():
    ...
    from q1k.segment.tasks import TASK_PARAMS, segment_to
    return (mne, mne_bids, np, plt, warnings, segment_to,
...
def header(subject_id, task_id):
    import marimo as mo
    mo.md(f"# Single Subject Segmentation Q1K - TO\n\n"
...
@app.cell
def create_epochs(segment_to, eeg_raw, eeg_events, eeg_event_dict):
    epochs, event_id, conditions = segment_to(
