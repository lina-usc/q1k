...
def header(subject_id, task_id):
    import marimo as mo
    mo.md(f"# Single Subject Segmentation Q1K - AEP\n\n"
...
@app.cell
def create_epochs(segment_aep, eeg_raw, eeg_events, eeg_event_dict):
    epochs, event_id, conditions = segment_aep(
