...
def eeg_et_combine(eeg_raw, et_raw, eeg_times, et_times,
    ...
    #    return data
    #et_raw.apply_function(replace_nan)
    ...
    #print("combine #4 eeg:", np.nanmax(np.abs(eeg_raw.get_data("pupil_left"))))
    #print("combine #4 et:", np.nanmax(np.abs(et_raw.get_data("pupil_left"))))
